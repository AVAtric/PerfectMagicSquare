//
// Visual test: runs an 8x8 solve in verbose mode to show the genetic algorithm
// evolving in real time. Always prints the top candidates each generation.
//
...
int main() {
    std::cout << "=== Visual Test: 8x8 Magic Square (verbose) ===" << std::endl;
